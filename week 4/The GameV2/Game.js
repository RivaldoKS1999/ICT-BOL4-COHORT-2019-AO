...
var answer = prompt("Welkom " + naam + " . Je komt aan in een haven, je hebt twee opties, je gaat mee met het grote vrachtschip of het kleine zeilbootje");




if(answer == 1){
alert("Je hebt gekozen voor het vrachtschip, er zitten veel giftige spinnen aan boord! oppassen! uiteindelijk vaar je zondere andere complicaties naar het onbekende eiland");
}   
else if(answer == 2){

alert("Je hebt voor het zeilbootje gekozen, je vaart zonder enkele problemen naar het onbekende eiland");
location.answer(false);
}



var v1 = prompt("Je komt bijna aan bij het onbekende eiland. Maar hoe wil je aanmeren??. \n1) zwemmend. \n2) met een bootje, \n\n (Type 1 of 2)");

if(v1 == 2){

alert("Je hebt gekozen ");
}   
else if(v1 == 1 ){
